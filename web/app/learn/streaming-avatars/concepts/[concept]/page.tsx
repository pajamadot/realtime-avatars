  ...
  return (
    <div>
      ...
      <nav className="mb-8 flex items-center gap-2 text-sm text-[var(--text-muted)]">
        ...
        <span>/</span>
        <Link href="/learn/streaming-avatars" className="hover:text-[var(--accent)]">Streaming Avatars</Link>
        <span>/</span>
          ...
          <div className="card p-6">
            {concept.visual.type === 'interactive' && concept.visual.demoId && (
              <div className="text-center py-8">
                ...
                <Link
                  href={`/learn/streaming-avatars#demo-${concept.visual.demoId}`}
      ...
      <section>
        <div className="flex items-center justify-between pt-8 border-t border-[var(--border)]">
          <Link
            href="/learn/streaming-avatars"
            className="badge hover:border-[var(--border-strong)]"
          >
            ← Back to Streaming Avatars
          </Link>
          <Link
            href="/learn/streaming-avatars#concepts"
            className="badge hover:border-[var(--border-strong)]"
          >
            View All Concepts
          </Link>
